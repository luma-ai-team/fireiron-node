...
__exportStar(require("./src/actions/user"), exports);
...
__exportStar(require("./src/utils/poller"), exports);
class Fireiron {
    constructor(exports) {
    ...
    registerAction(action, options = {}) {
        ...
        this.exports[name] = (0, https_1.onCall)(options, async (request) => {
            ...
            const userIdentifier = (_a = request.auth) === null || _a === void 0 ? void 0 : _a.uid;
            if (userIdentifier == null) {
                Logger.error("Unauthenticated request", request.data);
                throw new Error("Unauthenticated request");
            }
            return await action.run(request.data, userIdentifier);
        });
    }
