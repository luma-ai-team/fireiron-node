...
exports.PredictionHook = exports.PredictionWebhookParameters = void 0;
...
class PredictionWebhookParameters {
    constructor(domain, endpoint, source, user) {
        this.domain = domain;
...
exports.PredictionWebhookParameters = PredictionWebhookParameters;
;
class PredictionHook {
    ...
    makeParameters(user, source, parent) {
