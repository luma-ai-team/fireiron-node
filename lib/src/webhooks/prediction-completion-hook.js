...
class PredictionCompletionHook {
    ...
    makeParameters(user, source, identifier, parent) {
        var _a;
        const options = new PredictionCompletionWebhookParameters(this.domain, (_a = this.endpoint) !== null && _a !== void 0 ? _a : this.name, source, user);
    ...
    async handleUpdate(event, userIdentifier) {
        ...
        await predictionReference.update({
            metatada: Object.assign(Object.assign({}, data.metadata), event.metadata),
    ...
    async handleFailure(event, userIdentifier) {
        ...
        await this.firestore.deposit(userIdentifier, (_a = data.cost) !== null && _a !== void 0 ? _a : 1);
    }
}
