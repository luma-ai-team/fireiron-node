...
class FirestoreAdapter {
    ...
    async makeUserData(identifier) {
        ...
        const redeemLimit = (_d = await ((_c = defaults.data()) === null || _c === void 0 ? void 0 : _c.redeemLimit)) !== null && _d !== void 0 ? _d : 0;
        return {
    ...
    async createPrediction(userIdentifier, input, cost, metadata) {
    ...
    async createLinkedPredictions(userIdentifier, prediction, count) {
        var result = [];
